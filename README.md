...
5. Per YouTube abilita YouTube Data API v3 nel tuo progetto Google Cloud e crea una API key limitata a tale API. Inseriscila nel campo dedicato oppure nell'ambiente `YOUTUBE_API_KEY`. La modalità manuale non richiede questa chiave.
